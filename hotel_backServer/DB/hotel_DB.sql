...
-- 正在导出表  hotel_db.入住登记表 的数据：~4 rows (大约)
INSERT INTO `入住登记表` (`订单编号`, `服务人员编号`, `房间号`, `证件号码`, `姓名`, `入住日期`, `押金`, `预计离开日期`) VALUES
	...
	('AmCKa4wVGRh4', 'staff123', '505', '431032137978139289', '张三', '2024-06-03 00:00:00', 200, '2024-06-06 00:00:00'),
	('dasd@43dsfhyt0', 'staff123', '302', '430426123728894794', 'pyy', '2024-06-03 00:00:00', 200, '2024-06-05 00:00:00');
...
-- 正在导出表  hotel_db.接站预约表 的数据：~0 rows (大约)
INSERT INTO `接站预约表` (`接站订单编号`, `接送形式编码`, `订单编号`, `接站日期`, `接站地址`, `完成状态`) VALUES
	('wduydablih213', '2', 'AmCKa4wVGRh4', '2024-05-27 20:39:12', '北京大兴国际机场', '已完成');
...
-- 正在导出表  hotel_db.用户表 的数据：~8 rows (大约)
INSERT INTO `用户表` (`用户ID`, `用户名`, `姓名`, `证件号码`, `年龄`, `证件类型`, `性别`, `联系电话`, `邮箱`, `登录密码`) VALUES
	('b8GVPKca', 'new-count', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '12345678'),
	...
	('RDfRRwIX', 'pyy02080024', '彭语仪', '430503200502080024', 19, '身份证', '女', '15115918637', '2524489271@qq.com', '2524489271'),
...
-- 正在导出表  hotel_db.订单表 的数据：~7 rows (大约)
INSERT INTO `订单表` (`订单编号`, `用户ID`, `房型号`, `证件号码`, `预计入住日期`, `预计离开日期`, `预计住宿费用`, `定金支付状态`) VALUES
	...
	('2Ydwuygd+dg', 'SLTlkQzk', '8', '430426123728894794', '2024-05-29', '2024-05-31', 200, '未支付'),
	...
	('dasd@43dsfhyt0', 'SLTlkQzk', '2', '430426123728894794', '2024-06-03', '2024-06-07', 300, '未支付'),
	('f0cupecQZLkO', 'RDfRRwIX', '3', '430503200502080024', '2024-06-06', '2024-06-07', 288, '未支付'),
	('W1GDNCPsqZ84', 'DSP1XuS0', '2', '431032137978139289', '2024-06-05', '2024-06-08', 708, '未支付');
...
-- 正在导出表  hotel_db.账单表 的数据：~3 rows (大约)
INSERT INTO `账单表` (`订单编号`, `用户ID`, `服务人员编号`, `实际住宿费用`, `预计住宿费用`, `点餐费用`, `损坏费用`, `接站费用`, `送站费用`, `押金`, `总费用`, `退房日期`, ` 支付状态`) VALUES
	('1234', 'w1he3-BY', 'staff123', 472, 1416, 0, 0, 0, 0, 32, -2360, '2024-06-03 00:00:00', '未支付'),
	('2Ydwuygd+dg', 'SLTlkQzk', 'staff123', 4000, 200, 0, 0, 0, 0, 200, 3600, '2024-06-03 00:00:00', '未支付'),
...
-- 正在导出表  hotel_db.退房登记表 的数据：~3 rows (大约)
INSERT INTO `退房登记表` (`退房日期`, `损坏费用`, `损坏情况描述`, `订单编号`, `服务人员联系电话`, `实际住宿费用`) VALUES
	('2024-06-03 00:00:00', 0, '无', '1234', 'staff123', 472),
	('2024-06-03 00:00:00', 0, '无', '2Ydwuygd+dg', 'staff123', 4000),
...
INSERT INTO `送站预约表` (`送站订单编号`, `接送形式编码`, `订单编号`, `送站日期`, `送站地址`, `完成状态`) VALUES
	('5abDUMXpHIiX', '3', 'AmCKa4wVGRh4', '2024-05-31 14:31:20', '大兴国际机场', '已完成'),
	('Qz_6vE7MLRR5', '2', 'f0cupecQZLkO', '2024-06-06 16:00:00', '机场', '未完成');
